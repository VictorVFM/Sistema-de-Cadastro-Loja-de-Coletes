...
public class PainelPesquisarCodigo extends JPanel{
	...
	public PainelPesquisarCodigo(List<Produtos> produtos) {
		super();
	...
	private void iniciarComponentes() {
		...
		jtfPesquisar.setText("Insira o Código do Produto");
	...
	private void iniciarEventos() {
		...
		jbPesquisar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (Produtos produto : produtos) {
					/*SE O CÓDIGO CADASTRADO NA MATRIZ FOI IGUAL AO ESCRITO, VAI CAIR NO IF*/
					if (produto.getCodigo().equals(jtfPesquisar.getText())) { 
				...
				if (!achou) {
					JOptionPane.showMessageDialog(null, "Código não Encontrado", "Pesquisar", JOptionPane.WARNING_MESSAGE);
				}
			}
		});
		...
		jtfPesquisar.addFocusListener(new FocusListener() {
			...
			public void focusGained(FocusEvent e) {
				...
				if (jtfPesquisar.getText().equals("Insira o Código do Produto")) { 
